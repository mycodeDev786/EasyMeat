      ...
      >
        ...
        <div className="glass border border-white/10 rounded-2xl p-8">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 hover:border-white/30 text-white py-3 rounded-xl font-medium transition-all mb-6"
          >
            <FcGoogle size={20} />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/auth/forgot-password" className="text-gold text-sm hover:underline">Forgot password?</Link>
            </div>
            <button
              type="submit" disabled={loading}
              className="w-full btn-gold py-3.5 rounded-xl font-bold text-base disabled:opacity-50"
            >
          ...
          <p className="text-center text-gray-400 text-sm mt-6">
            ...
            <Link href="/auth/register" className="text-gold hover:underline font-medium">Create Account</Link>
          </p>
        </div>
      </motion.div>
    </div>
